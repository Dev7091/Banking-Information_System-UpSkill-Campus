...
public class GUI {
	...
	public void openSignInForm(JFrame frame, Login_Account user) {
		...
		// main screen picture
		JLabel imgLabel = new JLabel(new ImageIcon( System.getProperty("user.dir") + "\\BM_System\\src\\def_pkg\\anchor.png"));
	...
	// sign up form 1, getting account# and Aadhar# from user
	/**
	...
	void open_Signup_form_1(JFrame frame, Login_Account user)
	{
		...
		lSignUp.setBounds(290,54,300, 40);
		f.add(lSignUp);
			
		//-----------------------------------------Creating Labels-------------------------------------		
		JLabel l_AccountNo = new JLabel("Enter Account Number:");
		l_AccountNo.setBounds(200,110,150, 90);
		f.add(l_AccountNo);
		
		JLabel l_CNIC = new JLabel("Enter Adhar Card Number:");
		l_CNIC.setBounds(200, 180, 160, 90);
		f.add(l_CNIC);
		...
		tf_CNIC.setBounds(350,213,200, 25);
		f.add(tf_CNIC);
		...
		btn_Verify_Account.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
					...
					{
						JOptionPane.showMessageDialog(f, "No account found with this Aadhar No.");
						// **************************************
						System.out.println("The Aadhaar no. did not match with any client");
						frame.remove(f);
						frame.repaint();
						frame.validate();
						openSignInForm(frame, user);
	...
	void eStatement2(JFrame frame, Client client, Bank_Account account) {
	    ...
	    SpinnerModel fromYearValues =  new SpinnerNumberModel(2018, 2018, 2023, 1);  
	    ...
	    // Day, Month and Year for From Date
 	    ...
 	    SpinnerModel toYearValues =  new SpinnerNumberModel(2023, 2018, 2023, 1);  
	...
	public void openCreateAccountForm(JFrame frame, Manager manager) {
		...
		f.add(l_motherName);
		JLabel l_cnic = new JLabel("Aadhar No.: ");
		...
		btn_create.addActionListener( new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if( res == 1 ) {
					...
					JOptionPane.showMessageDialog(f, "Another account with this Aadhar number exists");
				else
	...
	void open_manage_card_page(JFrame frame, Manager manager)
	{
		...
		//		Account Opening Date
		JLabel l_cnic = new JLabel("Enter Aadhar of account holder");
	...
	void open_block_unblock_account_page(JFrame frame, Manager manager)
	{
		...
		JLabel l_cnic = new JLabel("Enter Aadhar no.:");
	...
	void open_close_account_page(JFrame frame, Manager manager)
	{
		...
		JLabel l_cnic = new JLabel("Enter Aadhar:");
	...
	void searchAccount(JFrame frame, Manager manager) {
		...
		// Client Aadhar
		JLabel lCCNIC = new JLabel("Aadhar: ");
		...
		btnSearch.addActionListener( new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				// Both client and his account was found
					...
					lCCNIC.setText("Aadhar:  "+client.getCNIC() );
	...
	void searchForm(JFrame frame, Accountant accountant, int case_) {
		...
		// Aadhar Number Label
		JLabel lCnic = new JLabel("Enter Aadhar number:");
	...
	void depositCash(JFrame frame, Accountant accountant, Client client, Bank_Account account) {
		...
		// Aadhar Label
		JLabel lCnic = new JLabel( "Aadhar: " + client.getCNIC() );
	...
	void eStatement(JFrame frame, Accountant accountant, Client client, Bank_Account account) {
		...
		SpinnerModel fromYearValues = new SpinnerNumberModel(2018, 2018, 2023, 1); // Corrected fromYearValues
		JSpinner fromYearSpinner = new JSpinner(fromYearValues);
		fromYearSpinner.setBounds(150, 150, 55, 25);
		f.add(fromYearSpinner);

		// Day, Month and Year for To Date
		SpinnerModel toDayValues = new SpinnerNumberModel(30, 1, 31, 1);
		JSpinner toDaySpinner = new JSpinner(toDayValues);
		...
		SpinnerModel toYearValues = new SpinnerNumberModel(2023, 2018, 2023, 1); // Corrected toYearValues
		JSpinner toYearSpinner = new JSpinner(toYearValues);
